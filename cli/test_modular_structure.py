...
def test_imports():
    ...
    try:
        ...
        from ciso_assistant_mcp.config import make_request, format_table
    ...
    for module_name, function_name in modules:
        try:
            module = __import__(f'ciso_assistant_mcp.modules.{module_name}', fromlist=[function_name])
...
def main():
    ...
    if tests_passed == total_tests:
        ...
        print("⚠️  Some tests failed. Please check the structure and fix any issues.")
        return False
